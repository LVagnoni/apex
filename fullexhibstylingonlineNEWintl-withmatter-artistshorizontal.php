                        ...
                        <div class="col-lg-3 col-md-4 col-sm-12 push-right">
                            <div class="project-meta-wrapper meta-right-sidebar">';
                                echo '<ul class="single-portfolio-meta">
                                    <li>';
                                    echo'<h5><span>On view at <br>'.$exttop.'&nbsp;</span>';echo date('F j',strtotime($sdate));
                                                                 echo ' - ';
                                                                 echo date('F j, Y',strtotime($edate));

                                      echo'</h5>';
                                    echo'<a href="'.$openURL.'" target="_blank"><span>Opening:&nbsp;</span>';echo date('D, M j, H:i',strtotime($otime)); echo'</a>
                                    <br>
                                    <br>';
