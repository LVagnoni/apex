...
?>
	...
	$query = sprintf("INSERT INTO `teachers_highschool_interest` (`created_on`, `name`, `email`, `college`, `grade`, `dept`, `title`, `classname`, `other`, `learn0`, `learn1`, `learn2`, `learn3`, `learn4`, `learn5`, `learn6`, `learn7`, `learn8`, `learn9`, `learn10`) VALUES(NOW(),'%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s')",
        ...
        mysql_real_escape_string($_POST['classname']),
        ...
        mysql_real_escape_string($_POST['learn7']),
        mysql_real_escape_string($_POST['learn8']),
        mysql_real_escape_string($_POST['learn9']),
        mysql_real_escape_string($_POST['learn10']));
...
$to      = 'info@apexart.org';
$subject = 'High School Program Interest';
	
$message = 'High School Program Interest'.
					  nl2br($body)
					."
