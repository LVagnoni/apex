...
<meta http-equiv="Content-Type" content="text/html; charset=iso-8859-1">
	...
	$resultw="";
 	//error_reporting(E_ALL);
			...
			$query = sprintf("INSERT INTO exhiborg (`id`, `name`, `email`, `guidelines`, `questions`, `feedback`, `supportive`, `helpful`, `sense`,`better`,`changes`,`challenges`,`success`,`attendance`,`advice`,`other`,`created_on`) 
...
List up to three unexpected challenges that you had to address. How did you deal with these issues? What worked, and what didn’t work?<br/> 
...
Is there anything you would do differently next time (an artist selection, venue [for International Exhibitions], <br /> shipping method, installation decision, or anything else)?<br/> 
	{$_POST['changes']} <br/> <br/> 
