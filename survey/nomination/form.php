  ...
  <tr valign="top">
    ...
    <td width="947" colspan="3" align="center" valign="top"><table width="941" border="0" bgcolor="#FFFFFF">
      <tr valign="top">
        ...
        <span class="exhibitionProgram"><strong><p>apexart Incoming New York City Fellowship Recommendation Form</p></strong></span>
        <br /><table class="standardText">
          <tr>
            <td height="33" colspan="2" align="left" valign="top"><p>Thank you for your interest in submitting a nomination for the apexart Fellowship. The apexart Fellowship is unusual. It is not a residency program, and Fellows do not receive a studio or an exhibition as part of the opportunity. It is a rigorous month-long program of diverse activities that requires a clear understanding and commitment to participate on the part of the Fellow. Additionally, Fellows must agree not to produce work or engage in career promotion during the Fellowship. Nominees must be over 21 years old and the ideal candidate tends to be over 30. You must have known your nominated applicant for at least 3-6 months. Artists enrolled in graduate or undergraduate programs at the time of nomination are not eligible.
            <br><br>
          ...
          <tr>
            <td height="30" colspan="2" align="left" valign="top"><br />
              <p><input type="checkbox" name="nyc" value="YES" />&nbsp;My nominee has never visited New York City.<br />
              </p></td>
          </tr>
        </table>
        <span class="standardText">
         <input type="submit" id="submit" value="Submit">         
          </form><br><br><p>Thank you for your valuable recommendation to apexart's Fellowship Program. Please note that more candidates are considered than apexart can accommodate. We will contact you with further details regarding your nominee’s application status.
          <br><br>
          If you have further questions in regard to the program and/or its expectations please feel free to contact us at info@apexart.org.</p>
