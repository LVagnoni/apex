	...
	<table width="840" align="center">
        <tr valign="top"> 
          ...
          <td width="840" height="35" colspan="3" class="exhibitionProgram">
              <p class="exhibitionProgram"><strong>apexart</strong> Post-Fellowship Evaluation</p>
		  </td>
        </tr>
...
You've done the Fellowship and the one-month survey, and now we're asking you to fill in the short questionnaire below to get more feedback on the long-term effects of the program. We really want to hear about how this program factored in to your experiences in the long term so we can help make it more beneficial and fulfilling for participants in the future. Looking forward to getting your feedback!<br><br> Thank you,<br><strong>apexart </strong>staff<br><br>
            ...
            <table class="standardText">
                ...
                <tr> 
                  ...
                  <tr> 
                  <td height="30" align="left" valign="top"><br>
                   9. Have you used/looked at the new apexart blog (<a href="http://blog.apexart.org" target="_blank">blog.apexart.org</a>) since your Fellowship? Would you like login information to continue posting?  <br>
