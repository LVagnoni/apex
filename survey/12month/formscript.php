...
<meta http-equiv="Content-Type" content="text/html; charset=iso-8859-1">
	...
	$query = sprintf("INSERT INTO 12month (`created_on`, `name`, `res_dates`, `standout`, `person`, `refer`, `attend`, `psych`, `broaden`, `creative`,`return`,`social`, `sent`, `suggestion`) VALUES(NOW(),'%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s')",
