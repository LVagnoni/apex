...
<head>
    ...
    <title>apexart :: High School Students Follow Up Survey</title>
...
<!-- Service section start -->
            <div class="container2">
              ...
              <form action="student-followup-formscript.php" method="post" name="input" id="myform" onsubmit="return validate_form(this)" enctype="multipart/form-data">
                <div class="row2">
                      <h3><strong>HIGH SCHOOL PROGRAM - Student Follow Up</strong></h3> 
                </div>
                <!--<div class="row2">
                    <label for="fname">
                      Goals:<br>
...
<br><br>
               ...
               <div class="row2">
                  <div class="col-100">
                    <label for="fname" class="check"><br>Did you participate in the apexart Fellowship Session?</label>
                  </div>
                </div>
                <div class="row2">     
                  <div class="col-100">
               ...
               <div class="row2">
                  <div class="col-100">
                    <label for="fname" class="check">Did the questions and class activity make you think differently about creativity or what being an artist is?</label>
                  </div>
                </div>
               <div class="row2">     
                <div class="col-100">
               ...
               <div class="row2">
                  <div class="col-100">
                    <label for="fname" class="check">Can you share one example of something new that you realized about art and artists that you hadn’t thought of before?</label>
                  </div>
                </div>
               <div class="row2">     
                <div class="col-100">
               ...
               <div class="row2">
                  <div class="col-100">
                    <label for="fname" class="check">Was there a most favorite or least favorite part of the apexart Fellowship Session?</label>
                  </div>
                </div>
               <div class="row2">     
                <div class="col-100">
               ...
               <div class="row2">
                  <div class="col-100">
                    <label for="fname" class="check">If you were the teacher of this session for another class, what would you add or change?</label>
                  </div>
                </div>
               <div class="row2">     
                <div class="col-100">
