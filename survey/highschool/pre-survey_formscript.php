...
?>
	...
	$query = sprintf("INSERT INTO `students_highschool_presurvey` (`created_on`, `name`, `school`, `learn0`, `learn1`, `learn2`, `learn3`, `learn4`, `learn5`, `learn6`, `issue`, `best`, `role`, `kind`, `share`) VALUES(NOW(),'%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s')",


		mysql_real_escape_string($_POST['name']),
        mysql_real_escape_string($_POST['school']), 
	    mysql_real_escape_string($_POST['learn0']),
        mysql_real_escape_string($_POST['learn1']),
        mysql_real_escape_string($_POST['learn2']),
        mysql_real_escape_string($_POST['learn3']),
        mysql_real_escape_string($_POST['learn4']),
        mysql_real_escape_string($_POST['learn5']),
        mysql_real_escape_string($_POST['learn6']),
        mysql_real_escape_string($_POST['issue']),
        mysql_real_escape_string($_POST['best']),
        mysql_real_escape_string($_POST['role']),
        mysql_real_escape_string($_POST['kind']),
...
Do you have a preferred medium to best express your ideas?
{$_POST['learn0']}
{$_POST['learn1']}
{$_POST['learn2']}
{$_POST['learn3']}
...
Is there a specific concern, issue or theme that you consider when you create? 
{$_POST['issue']}    

Do you think there is a defined role of the artist in society and is it different from the responsibility of others? 
{$_POST['role']}   
                
Is there a specific kind of art, or an artist, that you particularly like and admire? How would you describe their work and what you like about it?
{$_POST['kind']}              
                 
Share 1 question about the art world:
{$_POST['share']} 
