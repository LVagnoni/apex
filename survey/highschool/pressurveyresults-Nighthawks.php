...
<TITLE>apexart :: HIGH SCHOOL PROGRAM - PRE-SESSION SURVEY RESULTS</TITLE>
		<table width="850" align="center"><tr><td class="standardText"><br /><br />HIGH SCHOOL PROGRAM - PRE-SESSION SURVEY RESULTS - The Nighthawks Teen Leadership Program<br />
        <br /><br /></td>
	...
	$query="SELECT * FROM students_highschool_presurvey WHERE school = 'Nighthawks' ORDER BY created_on DESC";
