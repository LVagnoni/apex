...
<TITLE>apexart :: HIGH SCHOOL PROGRAM - PRE-SESSION SURVEY RESULTS</TITLE>
		<table width="850" align="center"><tr><td class="standardText"><br /><br />HIGH SCHOOL PROGRAM - PRE-SESSION SURVEY RESULTS - Arts and Humanities LPS Focus - 9th grade<br />
        <br /><br /></td>
	...
	$query="SELECT * FROM students_highschool_presurvey WHERE school = 'LPS 9th Grade' ORDER BY created_on DESC";
