...
if (mysql_num_rows($query) > 0)
{
   ...
   //Iterate over the MySQL results and print the data
    ...
    
    {
        ...
        $otime = $result['otime'];
        $etime = $result['etime'];
        $onlineotime = $result['online_otime'];
        $onlineetime = $result['online_etime'];
        $pre = $result['pre'];
        $nex = $result['nex'];
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3 col-md-4 hidden-sm hidden-xs push-right">
                          &nbsp;
                            ...
                            <embed src="https://my.matterport.com/show/?m=K5MpUw93XYv&play=1" class="embed" style="height: 500px;"><br>
                                <div class="image_caption">Use your up, down, left, and right keys to navigate.</div>
                        </div>
                        ...
                        <div class="col-lg-3 col-md-4 col-sm-12 push-right">
                            <div class="project-meta-wrapper meta-right-sidebar">';
                                echo '<ul class="single-portfolio-meta">
                                    ...
                                    <a href="https://www.eventbrite.com/e/opening-reception-ctrlaltyellow-tickets-169508162477"><span>In person Opening:&nbsp;</span>';echo date('D, M j, g:i',strtotime($otime)); echo'&nbsp;PDT - RSVP</a><br>
                                     <a href="https://www.eventbrite.com/e/opening-curatorial-tour-ctrlaltyellow-tickets-169142454635"><span>Online Tour:&nbsp;</span>';echo date('D, M j, g:i',strtotime($onlineotime)); echo'&nbsp;EDT - RSVP</a>
                                    <br>
                                    <br>
