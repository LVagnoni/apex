<?php
    ...
    <div align="center">
	<div class="exhibitionProgram">Votes by Rebecca Forstater's class</div><br>
	<?php
	include ('../connect.php');


	$sql = "SELECT COUNT(*) FROM intl23_rating WHERE juror_id IN (444,445,446,447,448,449)";
	...
	echo "<div class='orangeText'><strong>Number of votes submitted by class: $num  &#183;&#183;&#183; Total votes by all jurors: $num2</strong> </div><br> ";
		...
		$query3="SELECT first, last, id, login_on, password FROM intl23_juror WHERE class=15 ORDER BY first ASC";
