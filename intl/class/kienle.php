<?php
    ...
    <div align="center">
	<div class="exhibitionProgram">Votes by Miriam Kienle's class</div><br>
	<?php
	include ('../connect.php');


	$sql = "SELECT COUNT(*) FROM intl23_rating WHERE juror_id IN (440,441,442,443)";
	...
	echo "<div class='orangeText'><strong>Number of votes submitted by class: $num  &#183;&#183;&#183; Total votes by all jurors: $num2</strong> </div><br> ";
		...
		$query3="SELECT first, last, id, login_on, password FROM intl23_juror WHERE class=14 ORDER BY first ASC";
