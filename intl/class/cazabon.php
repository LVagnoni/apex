<?php
    ...
    <div align="center">
	<div class="exhibitionProgram">Votes by Lynn Cazabon's class</div><br>
	<?php
	include ('../connect.php');


	$sql = "SELECT COUNT(*) FROM intl23_rating WHERE juror_id IN (255,256,257,258,259,260,261,262,263,264,265,266)";
	...
	echo "<div class='orangeText'><strong>Number of votes submitted by class: $num  &#183;&#183;&#183; Total votes by all jurors: $num2</strong> </div><br> ";
		...
		$query3="SELECT first, last, id, login_on, password FROM intl23_juror WHERE class=5 ORDER BY first ASC";
