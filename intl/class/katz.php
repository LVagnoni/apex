<?php
    ...
    <div align="center">
	<div class="exhibitionProgram">Votes by Nathaniel Katz's class</div><br>
	<?php
	include ('../connect.php');


	$sql = "SELECT COUNT(*) FROM intl23_rating WHERE juror_id IN (294,295,296,297,298,299,300,301,302,303,304,305,306,307,308,309,310,311)";
	...
	echo "<div class='orangeText'><strong>Number of votes submitted by class: $num  &#183;&#183;&#183; Total votes by all jurors: $num2</strong> </div><br> ";
		...
		$query3="SELECT first, last, id, login_on, password FROM intl23_juror WHERE class=9 ORDER BY first ASC";
