<?php
	...
	$sql = "SELECT COUNT(*) FROM intl23_rating WHERE juror_id IN (640,641,642,643,644,645,646,647,648,649,650,651,652,653,654)";
	...
	echo "<div class='orangeText'><strong>Number of votes submitted by class: $num  &#183;&#183;&#183; Total votes by all jurors: $num2</strong> </div><br> ";
		...
		$query3="SELECT first, last, id, login_on, password FROM intl23_juror WHERE class=26 ORDER BY first ASC";
