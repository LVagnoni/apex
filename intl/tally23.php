...
<?php
                ...
                <table align="left" bgcolor="#FFFFFF">
                    <tr>
                        <td height="34" colspan="4" valign="top">
                            <span class="exhibitionProgram">INTL 2023 votes</span>
                        </td>
                    </tr>
                    <!--<tr>
                        ...
                        <td width="170" valign="top" class='standardTextSm'>
                            1 - So Jin Chun<br />
                            2 - Christian Gerstheimer 1<br />
                            3 - Christian Gerstheimer 2<br />
                            4 - Amish Morell<br />
                            5 - Kevin Chen 1<br />
                            6 - Ben Dunn<br />
                        </td>
                        <td width="181" valign="top" class='standardTextSm'>
                            7 - Shauna McCabe<br />
                            8 - Alejandro Acierto<br />
                            9 - Jennifer Nelson Kotsaras<br />
                            10 - Simon Wursten Martin<br />
                            11 - Leslie Lodwick<br />
                        </td>
                        <td width="183" valign="top" class='standardTextSm'>
                            12 - Susan Connolly<br />
                            13 - Chad Dawkins<br />
                            14 - Annie J. Kwan<br />
                            15 - Anna Campbell<br />
                        ...
                        <td width="183" valign="top" class='standardTextSm'>
                            17 - Emmanuel Auerbach<br />
                            17 - Amanda Couch<br />
                            19 - Jessye McDowell<br />
                            20 - Betsy Hawley<br />
                            21 - Helena Reckitt<br />
                            22 - Paul O'Neill<br />
                        </td>
                        <td width="183" valign="top" class='standardTextSm'>
                            23 - Suzanne Mooney<br />
                            24 - Media Farzin-Rad<br />
                            25 - CAE NYC<br />
                            26 - Kevin Chen 2<br />
                            27 - Joan Giroux<br />
                            28 - Roxana Abdoly<br />
	...
	<?php
	include ('connect.php');
	$sql = "SELECT COUNT(*) FROM intl23_rating";
	$result = mysql_query($sql);
	$num = mysql_result($result, 0);

	$sql_limiter = "SELECT COUNT(checked_count) FROM intl23_proposal WHERE checked_count < vote_limiter;";
    ...
    "   <div class='orangeText'><strong>Total votes by all jurors: $num2</strong></div>
		...
		$query3="SELECT first, last, id, class, login_on, password FROM intl23_juror WHERE login_on IS NOT NULL ORDER BY class, first ASC";
		...
		$query = "SELECT * FROM intl23_proposal WHERE is_accepted!=1";
	...
	*/
	...
	$query = "SELECT * FROM intl23_proposal WHERE is_accepted!=1 ORDER BY averageRate DESC";
	...
	while ($row = mysql_fetch_assoc($result)) {
		...
		echo "<td  width='50' class='grayback' style='border:1px solid white;' align-left class='standardText'>".$row["franchise_city"]."";
		if (!empty($row["franchise_state"])) {echo ", ".$row["franchise_state"]."";}
		echo "</td>";
		
		echo "<td  width='50' class='grayback' style='border:1px solid white;' align-left class='standardText'>".$row["franchise_country"]."</td>";
	...
	function printHEADERS()
	{
        ...
        "<table align='center'>
            <tr>
                ...
                <th class='grayback' style='border:1px solid white;' align-left class='standardText'>City</th>
