...
<head>
    ...
    <script> //countdown
        ...
        var countDownDate = new Date("Apr 6, 2023 03:00:00").getTime();
...
<!--<title>apexart :: Open Call Program :: Juror Voting</title>-->
            ...
            $nums2=mysql_num_rows($result2);
                                                            if ($nums2 === 10){include ('popup1.php');}
                                                             ...
                                                             elseif ($nums2 === 333){include ('popup5.php');}
                             ...
                             <tr valign="top">
                                 <td>
                                     ...
                                     while ($row = mysql_fetch_assoc($result)) {
                                        ...
                                        echo "</td></tr><tr>";
                                        echo "<td colspan=3 class='standard2' align=left>Voting has concluded for our International 2023 Open Call.";
