...
?>
	...
	$query = sprintf("INSERT INTO `teachers_opencall` (`created_on`, `name`, `email`, `college`, `grade`, `dept`, `title`, `other`, `learn`, `provide`, `signup`, `enjoy`, `group`, `required`, `surprise`, `inc`, `discuss`, `know`, `again`, `rec`, `future`, `resources`) VALUES(NOW(),'%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s')",
...
What classes/subjects did you use the program for (age, topic)?
{$_POST['other']}                  
				  
How did you learn about the apexart Open Call Student Juror Program? 
{$_POST['learn']}  

Was our signup process easy?
{$_POST['provide']}  

Please suggest additional support/info we could provide in the future.
{$_POST['signup']}  

Was student participation required or optional?
{$_POST['required']}  

How did you integrate the apexart Open Call Jury Process into your class syllabus? 
{$_POST['inc']}  

Can you summarize one or two important issues that were addressed?
{$_POST['discuss']}  

Did your class enjoy the process? Did they feel invested to look at the winners and follow the exhibitions?
{$_POST['know']}  

Did you use resources available on the apexart website (Open Call Jury Classroom Guide, past exhibitions and past open call proposals)?
{$_POST['enjoy']}  

Would you participate in the Open Call Jury process again? Why/why not? 
{$_POST['again']}  

What resources would be helpful to have available for your class- before, during or after the jury process?
{$_POST['resources']}  

WCare to recommend any of your colleagues to join the jury process or use the program? 
{$_POST['rec']}  

Would you consider submitting an exhibition proposal in the future?
{$_POST['future']}  				 
