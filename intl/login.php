...
session_start();
    ...
    if (isset($_POST["username"])){
        ...
        $query="SELECT * FROM intl23_juror WHERE username='".$xx."' LIMIT 1";
        ...
        if (is_array($row) AND !empty($row)) 
        {
            ...
            $query3="UPDATE intl23_juror SET login_on = NOW() WHERE `id`=".(int)$row["id"]." LIMIT 1";
