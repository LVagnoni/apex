                ...
                <div class="container">
                    <div class="row">
                        ...
                        <h2 class="single-project-title2"><em>'.$title.'</em></h2>
                                <div id="left"><h4 class="curator-title">'.$curby.' '.$curator.'</h4></div>';
                        ...
                        <div class="col-lg-3 col-md-4 hidden-sm hidden-xs push-right">
                          &nbsp;
                            ...
                            <div class="single-project-thumb-wrapper">
                                <a href="'.$image.'" data-lightbox="img-gallery"><img src="'.$image.'" alt=""></a>
                            ...
                            <div class="project-meta-wrapper meta-right-sidebar">';
                                echo '<ul class="single-portfolio-meta">
                                    ...
                                    <h5><span>On view at <br>'.$exttop.':&nbsp;</span>';echo date('F j',strtotime($sdate));
                                      ...
                                      echo'<br>Tues - Sat, 11am - 6pm</h5>
                                      <a href="'.$openURL.'" target="_blank"><span>';
                                   if ($otype == '0') {echo 'Online Opening:&nbsp;';}

                                   else {echo 'Opening:&nbsp;';}
                                    echo'</span>';echo date('D, M j, g:i a',strtotime($otime));
                                    echo ' - ';
                                    echo date('g:i a',strtotime($etime)); 
                                    echo ' ';
                                    if (!empty($timezone)) {echo $timezone;}
                                    echo '</a>';
                                    if ($otype == '2') {echo ' with curator present<br></a>
                                    <br>';}
                                    //if ($sdate >= curdate() && !empty($openURL)) {echo ' - RSVP';}
                                      echo'<h5><span>Online:&nbsp;</span><br>starting&nbsp;'; echo date('F j, Y',strtotime($openingnotime)); echo'</h5></li>
                                </ul>';
