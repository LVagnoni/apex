...
<!--<title>apexart :: Open Call Program :: Juror Voting</title>-->
            ...
            $query2="SELECT * FROM nyc23_rating WHERE juror_id=".$_SESSION["userID"];
            ...
            $nums2=mysql_num_rows($result2);
                                                            if ($nums2 === 10){include ('popup1.php');}
                                                             ...
                                                             elseif ($nums2 === 335){include ('popup5.php');}
            $sql = "SELECT * FROM nyc23_proposal WHERE checked_count < vote_limiter";
            $result = mysql_query($sql, $conn);
            $testCount = mysql_num_rows($result);


            $sql = "SELECT MIN(checked_count) as checked_count, MAX(vote_limiter) as vote_limiter, MIN(vote_limiter) as min_vote_limiter, COUNT(*) as total FROM nyc23_proposal";
            $result = mysql_query($sql, $conn);
            ...
            if ($result) {
                ...
                if($maxVoteLimiter === 0) {
                    ...
                    $sql = "UPDATE nyc23_proposal SET vote_limiter = " . VOTE_LIMITER_INCREASE_COUNT;
                    $res = mysql_query($sql, $conn);
                }
                else if ($minVoteLimiter < $maxVoteLimiter) {
                    // update vote limiter to max value
                    $sql = "UPDATE nyc23_proposal SET vote_limiter = " . $maxVoteLimiter;
                    $res = mysql_query($sql, $conn);
                } else if($testCount < 15 * $totalCount / 90 && $minCheckedCount > $maxVoteLimiter - 4) {
                    $updateVoteLimiter = $maxVoteLimiter + VOTE_LIMITER_INCREASE_COUNT;
                    $sql = "UPDATE nyc23_proposal SET vote_limiter = " . $updateVoteLimiter;
            ...
            $query2="SELECT * FROM nyc23_proposal WHERE is_accepted!=1"; // WHERE is_accepted=1 ";
            $result2 = mysql_query($query2, $conn);
                         ...
                         <table width="950" border="0" align="center" bgcolor="#FFFFFF">
                             <tr valign="top">
                                 <td>
                                     ...
                                     $sql = "SELECT proposal_id FROM nyc23_rating WHERE juror_id = " . $_SESSION["userID"];
                                     $result = mysql_query($sql, $conn);
                                     $condition = "";
                                     ...
                                     $query="SELECT * FROM nyc23_proposal";
                                     ...
                                     {
                                         echo "<br/><br/><br/><br/><br/><br/><br/><center><h2 style='color: black';>Come back later to vote for other proposals</h2></center>";
                                         die();
                                     }
                                     ...
                                     while ($row = mysql_fetch_assoc($result)) {
                                         ...
                                         echo "<td class='grayback' width=350 align=right style='text-transform: uppercase;'>submitted from: ".$row["country"]."</td>";
                                    ...
                                    /*    if (!isset($_SESSION["userID"]))
                                     ...
                                     if (isset($_SESSION["userID"]))
                                         echo "<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type='submit' value='SAVE VOTE/NEXT-->'></form><br><br><br><br>";
                                     else
