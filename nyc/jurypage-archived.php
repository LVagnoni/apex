...
<td width="938" colspan="3" align="center" valign="top"><table border="0" bgcolor="#FFFFFF">
   <tr valign="top">
     ...
     <td  width="514"><span class="standardText"><br /><strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;JUROR NOTES:</strong> 
               <ul>
                <li>Voting is technically over but we have a tie on two proposals and need your help. Please continue to vote until 6pm EST.</li>
...
$query="SELECT * FROM proposal WHERE id IN (431,478) ORDER BY RAND() LIMIT 1";
 ...
 /*THIS ONE ***********************************
  ...
  /*  $query="SELECT * , count(r.score) as 'cntt', avg(r.score)
    ...
    HAVING count(r.score)<65
    AND avg(r.score)>=3.13
...
$query="SELECT * , count(r.score) as 'cntt', avg(r.score)
  ...
  */
  ...
  echo '<form action="logvote.php" method="get" >'; 
  $sumbits=0;
...
/* if ($country = 'United States') {
  echo "".$row["state"]."";
    ...
    if (!isset($_SESSION["userID"])) echo "<br>Please <a href='login.php'>log in</a> to be able to vote.";
      else{
