...
<title>apexart :: NYC Exhibition Program 2022-23 :: Submissions</title>
<body bgcolor="#000000">

<table  width="845" align="center" border="0">
  <tr>
    <td><div class="exhibitionProgram">NYC Exhibition Program 2022-23 Submissions</div>
    <?php
	...
	$query="SELECT * FROM nyc23_proposal WHERE is_accepted=0 ORDER BY id desc";//WHERE is_accepted=0
	...
	while ($row = mysql_fetch_assoc($result)) {
		...
		$ff=$row["id"];
		$query2="SELECT avg(score) as 'aver' FROM nyc23_rating Where proposal_id=$ff";
		$result2 = mysql_query($query2, $conn); 
		...
		$query2="SELECT count(*) as 'cnt' FROM nyc23_rating Where proposal_id=$ff";
		$result2 = mysql_query($query2, $conn); 
        ...
        <a href='mailto:".$row["email"]."?subject=Re:%20Your%20Submission%20#".$rowID."&body=Dear%20".$row["submitters"].",%0A%0AThank%20you%20for%20submitting%20a%20proposal%20to%20apexart&#39;s%20Open%20Call%20for%20exhibitions.%20We%20are%20writing%20to%20get%20clarification%20on%20your proposal,%20as%20it%20currently%20does%20not%20seem%20to%20meet%20our%20qualifications%20and%20will%20not%20be%20sent%20to%20the%20jury%20without%20additional%20information.%0A%0AIt%20appears%20your%20proposal:%0A
			...
			'>
Email Submitter</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a><button>Disqualify Submission #".$row["id"]."</button></a>
		...
		$id = $row['id'];
		$queryb="SELECT * FROM nyc23_proposal WHERE id='" . $id . "'";
