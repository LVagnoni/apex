...
<head>
    ...
    <title>apexart :: NYC Exhibition Program 2023-24 :: Submission Page</title>
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
  ...
  //error_reporting(E_ALL);
      ...
      $query = sprintf("INSERT INTO nyc23_proposal (submitters, email, phone, artist_names, city, state, country, content, title, hear, hearinfo, created_on, mlist) VALUES('%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s',NOW(),'%s')",  
          ...
          $subject = "Open Call Submission for NYC / #$newUserID";
          
          
          $body = "Thank you for submitting a proposal to apexart's Open Call for NYC Exhibitions. \n
          <strong>Your ID# is $newUserID.</strong>\n
          Proposals will be accepted through October 31, 2022, and then undergo apexart's crowd-sourced jurying process with more than 700 jurors from around the world. Results will be <a href='https://www.apexart.org/nyc/results23.php'>announced here</a> the first week of December 2022.\n
    ...
    <!-- FORM GOES HERE -->
              ...
              <form action="submit-preview.php" method="post" name="input" id="myform" onsubmit="return validate_form(this)" enctype="multipart/form-data">
                <div class="row2">
                    <h2>Open Call NYC 2023-2024</h2>
...
Confirm that your proposal:
                ...
                <div class="row2">
                    ...
                    <input required type="checkbox" name="check[]" id="nonyc" value="yes" />&nbsp;is for an exhibition that will take place in NYC at apexart: 291 Church St.<br>
                ...
                <div class="row2">
                  <div class="col-25">
                    <label for="lname">Three examples of potential exhibition artists - (not visible by jurors):</label>
                  </div>
                  <div class="col-75">
