...
session_start();
    ...
    if (isset($_POST["username"])){
        $xx=mysqli_real_escape_string($_POST["username"], $conn);
        $yy=$_POST["password"];
        
            
        $query="SELECT * FROM nyc22_juror WHERE username='".$xx."' LIMIT 1";      
        ...
        if (is_array($row) AND !empty($row)) 
        {
            ...
            $query3="UPDATE nyc22_juror SET login_on = NOW() WHERE `id`=".(int)$row["id"]." LIMIT 1";
            //UPDATE Persons SET Age = '36' WHERE FirstName = 'Peter'
            $result3 = mysqli_query($query3, $conn); 
            header("location: jurypage.php");
            exit();
    ...
    if ($auth_failed) :
        echo "<tr align='center'><td class='verdana' size='4'>";
            echo "<br><br><br><br><br><br><br><center><a href='login.php'>WRONG LOGIN<br>Try Again</a><br><br><br><br><br><br><br>";
        echo "</tr></td>";
    endif;
        ?>
                        ...
                        <div class="col-xs-12">
                            <div class="xboot-tab-area clearfix">
                                <div class="tab-content">
                                    ...
                                    <h4><u>NYC Exhibition Program Juror Login and FAQs</u></h4>

          <br />
          <p>Thank you for helping us determine our schedule for next season as a Juror for apexart’s NYC Exhibition Program. We appreciate your time and input. Please read the following FAQs and then follow the prompts at the bottom of the page to login and access the proposals. Happy voting!<br />
...
<strong>Q: When is the jurying deadline?</strong><br />
    A: December 3, 2021, 23:59 PST </p>
    <br />
<form action="login.php" method="post">

                    
                    username:&nbsp;&nbsp;
                    <input type="text" size="20" maxlength="40" name="username" style="background-color:#000000;">&nbsp;&nbsp;&nbsp;&nbsp;
                    password:&nbsp;&nbsp;
                    <input type="text" size="20" maxlength="40" name="password" style="background-color:#000000;"><br><br \>
                    <input type="submit" style="width:200; height:35; background-color:#000000;" value="Log&nbsp;In">
