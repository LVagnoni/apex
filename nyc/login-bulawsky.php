...
session_start();
    ...
    if (isset($_POST["username"])){
        ...
        $query="SELECT * FROM juror WHERE username='".$xx."' LIMIT 1";      
        $result = mysql_query($query, $conn);
        if (!$result) {
            header('Location: login-bulawsky.php');
            exit;
        }
        ...
        if (is_array($row) AND !empty($row)) 
        {
            ...
            $query3="UPDATE juror SET login_on = NOW() WHERE `id`=".(int)$row["id"]." LIMIT 1";
    ...
    if ($auth_failed) :
        echo "<tr align='center'><td class='verdana' size='4'>";
            echo "<br><br><br><br><br><br><br><center><a href='login-bulawsky.php'>WRONG LOGIN<br>Try Again</a><br><br><br><br><br><br><br>";
        echo "</tr></td>";
    endif;
        ?>
...
<strong>Q: When is the jurying deadline?</strong><br />
    A: Thursday December 5, 2020, 23:59 PST </p>
    <br />
<form action="login-bulawsky.php" method="post">
